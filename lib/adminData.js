...
//
// (Tried forwarding Upstash's per-key Upstash-Sync-Token header across
// requests to fix a suspected replication-lag issue; a single shared
// token reused across different keys made things worse, not better, and
// an isolated probe without it was perfectly consistent — so plain
// requests it is. See git history if a genuine multi-key sync-token
// scheme is worth revisiting.)
